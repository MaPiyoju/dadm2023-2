...
@Composable
fun GameGrid(level: String, modifier: Modifier = Modifier) {
                        ...
                        if(moves.checkVictory(selectedIds, enemyIds) !== 0){
                            ...
                            if(((scoreMachine+scorePlayer).mod(2)) !== 0){
                                val enemyMove = when (level) {
                                    ...
                                    "Medium" -> moves.mediumMove(itemsData, selectedIds, enemyIds)
                                    else -> {
...
@Composable
fun TicTacToe(context: Activity){
    ...
    Scaffold(
        ...
        Surface(
            ...
            GameGrid(level = difficultyLevel)
        }
    }
}
